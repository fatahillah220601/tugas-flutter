...
void main() {
  runApp(MaterialApp(
    ...
    appBar: AppBar(
      ...
      actions: <Widget>[
        new IconButton(icon: new Icon(Icons.create, color: Colors.white)),
        new IconButton(icon: new Icon(Icons.delete, color: Colors.white)),
      ],
    ),
    body: Center(
      child: Column(children: <Widget>[
        Image.network(
          'https://i.ibb.co/Rv2tQB9/foto-1.jpg',
          width: 400.0,
          height: 400.0,
          fit: BoxFit.cover,
        ),
